...
class SpotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spot" do
    assert_difference('Spot.count') do
      post spots_url, params: { spot: { image: @spot.image, map: @spot.map, text: @spot.text, user_id: @spot.user_id } }
    end
  ...
  test "should update spot" do
    patch spot_url(@spot), params: { spot: { image: @spot.image, map: @spot.map, text: @spot.text, user_id: @spot.user_id } }
